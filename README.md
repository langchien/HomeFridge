# 🍳 HomieFridge - Hệ Thống Đi Chợ & Quản Lý Thực Phẩm Tiện Lợi (MVP)
...
| **🤖 Thiết bị thông minh (Device)** | *(Tùy chọn mở rộng)* Đồng bộ dữ liệu tủ lạnh tự động (quét mã, cảm biến...). |
